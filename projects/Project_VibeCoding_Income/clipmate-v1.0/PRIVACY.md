# ClipMate v1.0.1 Privacy Policy
...
user's Notion workspace or copies it as Markdown. Version 1.0.1 also provides
...
detection, Tutorial Mode and Asset Picker run locally. ClipMate does not send
page content to an AI service, classification service or analytics endpoint.
It does not download videos, fetch subtitles, read cookies or load remote code.
