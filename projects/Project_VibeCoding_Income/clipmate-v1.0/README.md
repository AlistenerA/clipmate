...
v1.0.1 在 v0.9.3 页面感知剪藏基础上增加可选的 Pro License、首次安装引导和版本隔离部署；现有剪藏能力继续免费。
...
3. 开启「开发人员模式」
4. 点击「加载解压缩的扩展」，选择 `clipmate-v0.9/dist/` 目录
...
生成 `clipmate-v0.9.zip`，仅包含 dist/ 构建产物，不包含源码、测试、文档、node_modules。
