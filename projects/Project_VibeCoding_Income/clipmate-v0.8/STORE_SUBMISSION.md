# STORE_SUBMISSION.md — ClipMate v0.8 商店提交材料

> 上架 Edge Add-ons / Chrome Web Store 时填写。v0.8 发布候选。
...
一键保存网页内容到 Notion。支持全文/选区/教程、手动点选图片、结构化代码公式表格与本地历史。

---

## 简短描述（英文备选，≤132 字符）

Save web content to Notion with tutorial structure, user-selected images, Markdown profiles, and local history.
...
ClipMate 是一款轻量级浏览器扩展，帮你把网页内容快速保存到 Notion，或复制为 Markdown。v0.8 新增 Asset Picker，可从当前页面手动补充、移除和排序图片，并继续保留 v0.7 的教程结构。
...
**v0.8 无权限变更。** Asset Picker 在现有 content script 中按用户操作显示临时覆盖层，不下载或上传图片，也不读取 cookie。
