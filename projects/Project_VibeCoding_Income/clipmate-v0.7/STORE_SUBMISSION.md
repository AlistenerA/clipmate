# STORE_SUBMISSION.md — ClipMate v0.7 商店提交材料

> 上架 Edge Add-ons / Chrome Web Store 时填写。v0.7 发布候选。
...
一键保存网页教程到 Notion。支持全文/选区/教程模式、结构化代码公式表格、图片题注、视频链接与本地历史。

---

## 简短描述（英文备选，≤132 字符）

Save web tutorials to Notion with headings, code, equations, tables, image captions, video links, Markdown profiles, and local history.
...
ClipMate 是一款轻量级浏览器扩展，帮你把网页内容快速保存到 Notion，或复制为 Markdown。v0.7 新增教程模式，将标题、代码、公式、表格、提示块、图片题注和视频链接映射为结构化 Notion blocks。
...
**v0.7 无权限变更。** 教程结构解析、视频链接元数据和 Notion 原生 block 映射均在现有权限范围内实现。
