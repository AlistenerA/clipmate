...
export const SEED_PROFILES: readonly SiteProfile[] = [
  ...
  },
  {
    ...
    priority: 20,
    selectorHints: {
      contentContainer: '#noteContainer .note-content, .note-content',
      commentContainer: '#noteContainer .comments-container, .comment-container',
    },
  },
  {
    id: 'tieba-community',
    ...
    priority: 30,
    selectorHints: {
      contentContainer: '.image-text, .pb-content-wrap',
      commentContainer: '.pc-pb-reply-list, .pb-comment-list',
      excludeSelector: '.thread-wrapper, .forum-topic-card, .add-post, .pc-pb-first-floor-interactive, .pc-pb-reply-box',
    },
  },
  {
